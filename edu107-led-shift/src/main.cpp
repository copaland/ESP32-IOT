...
*/
#include <Arduino.h>
int dataPin = 40;   //14 Pin connected to DS of 74HC595(Pin14)  
int latchPin = 41;  //12 Pin connected to ST_CP of 74HC595(Pin12)
int clockPin = 42;  //13 Pin connected to SH_CP of 74HC595(Pin11)          
